...
const ConsultarAdvogados = () => {
  return (
    <>
      <PageMeta 
        title="Consultar Advogados" 
        description="Consulta de advogados cadastrados" 
      />
      <div className="mb-6">
                ...
                <table className="w-full table-auto">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <p className="text-black dark:text-white">OAB/SP 123456</p>
                      </td>
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <p className="text-black dark:text-white">pedro.almeida@exemplo.com</p>
                      </td>
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <p className="text-black dark:text-white">(11) 97777-1111</p>
                      </td>
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                    ...
                    <tr>
                      ...
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <p className="text-black dark:text-white">OAB/SP 789012</p>
                      </td>
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <p className="text-black dark:text-white">luiza.costa@exemplo.com</p>
                      </td>
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <p className="text-black dark:text-white">(11) 95555-2222</p>
                      </td>
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
...
export default ConsultarAdvogados;